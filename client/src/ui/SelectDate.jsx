...
const ExampleCustomInput = forwardRef(({ value, onClick, width }, ref) => (
  <button
    ...
    className={`rounded-md border-2 border-gray-300/50 bg-white px-4  py-3 text-sm font-bold text-skin-black placeholder:text-black/85 hover:border-skin-purple dark:border-transparent dark:bg-skin-mirage`}
  >
    <p className="flex justify-between">
      <span className="mr-2 text-skin-black">{value}</span>
      <span>
        <i
