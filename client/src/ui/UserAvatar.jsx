  ...
  return (
    <div className="relative flex h-full items-center border-l-2 border-gray-500/50 px-8 xl:flex xl:w-full xl:justify-center xl:border-l-0 xl:border-t-2 xl:py-8">
      <button
        ...
        } dark:bg-skin-mirage peer absolute right-5 top-[40px]
          z-40 w-44 rounded-md bg-white  
      ...
      <img
        ...
        className="peer-hover:border-skin-purple h-10 w-10 cursor-pointer rounded-full border-transparent transition-all duration-100 hover:scale-105 hover:border-4 hover:border-purple peer-hover:scale-105 peer-hover:border-4"
        src={photo}
        alt="user avatar"
      />
    </div>
