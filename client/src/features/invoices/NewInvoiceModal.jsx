  ...
  return (
    <>
      <div
        ...
        }  dark:bg-skin-mirage2 fixed inset-0 top-20 z-20 h-[100vh-20rem] w-full overflow-y-scroll bg-white transition-all duration-300  md:w-2/3 xl:top-0 xl:w-1/2 xl:pl-28`}
      >
        <CreateInvoiceForm />
      </div>
      {/* overlay */}
